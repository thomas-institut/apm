...
class IllegibleBlot extends BlockEmbed {
  ...
  static create (value) {
    ...
    const size = Math.round(((IllegibleBlot.size-1)*0.2+1)*14)
...
class MarkBlot extends BlockEmbed {
  static create (value) {
    ...
    const size = Math.round(((MarkBlot.size-1)*0.2+1)*14)
...
class ChunkMarkBlot extends BlockEmbed {
  static create (value) {
    ...
    const size = Math.round(((ChunkMarkBlot.size-1)*0.2+1)*14)
...
class CharacterGapBlot extends BlockEmbed {
  static create (value) {
    ...
    const size = Math.round(((CharacterGapBlot.size-1)*0.2+1)*14)
...
class NoWordBreakBlot extends BlockEmbed {
  static create (value) {
    ...
    const size = Math.round(((NoWordBreakBlot.size-1)*0.2+1)*14)
...
class ParagraphMarkBlot extends BlockEmbed {
  static create (value) {
    ...
    const size = Math.round(((ParagraphMarkBlot.size-1)*0.2+1)*14)
...
class GlossBlot extends Block {
  ...
  static create(value) {
    ...
    node.setAttribute('place', value.place)
    const ruleIndex = GlossBlot.styleSheet.cssRules.length
