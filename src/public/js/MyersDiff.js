...
//       Variations", 1986
 ...
 class MyersDiff {
    ...
    *        }
    */
   static calculate(arrayA, arrayB, isEqual) {
     ...
     let snakes = this.extractSnakes(v_save, n, m);

     // Format the snakes as a set of instructions.
     return this.formatSolution(snakes);
   }

   static formatSolution(snakes) {
     let solution = []
     let x = 0
     let y = 0
     let seq = 0
   ...
   static extractSnakes(v_save, x, y) {
    let snakes = [];
