...
class OldTableEditor {
  ...
  confirmCellEdit(row, column) {
    ...
    this.dispatchEvent(OldTableEditor.tableChangeEvent, this.values)
  ...
  genOnDelete(column) {
    ...
    return function() {
      ...
      // dispatch change event
      thisObject.dispatchEvent(OldTableEditor.tableChangeEvent, thisObject.values)
  ...
  getSanitizedOptions(options) {
    ...
    if (typeof(options.cellEditMode) === 'string') {
      if (OldTableEditor.cellEditAllowedModes.indexOf(options.cellEditMode) !== -1) {
  ...
  getDefaultOptions() {
    return {
      ...
      textDirection: 'ltr',
      columnsPerTable: 10,
      cellEditMode: OldTableEditor.cellEditModeNone // three options: editTopRow, editAllButTopRow, none
    }
  }
  ...
  canEdit(row, column) {
    switch(this.options.cellEditMode) {
      case OldTableEditor.cellEditModeNone:
        return false

      case OldTableEditor.cellEditModeEditTopRow:
        return (row === 0)

      case OldTableEditor.cellEditModeEditAllButTopRow:
        return (row !== 0)
    }
  }
...
OldTableEditor.cellEditModeNone = 'none'
OldTableEditor.cellEditModeEditTopRow = 'topRow'
OldTableEditor.cellEditModeEditAllButTopRow= 'allButTopRow'

OldTableEditor.cellEditAllowedModes = [ OldTableEditor.cellEditModeNone, OldTableEditor.cellEditModeEditTopRow, OldTableEditor.cellEditModeEditAllButTopRow]

OldTableEditor.tableChangeEvent = 'tablechange'