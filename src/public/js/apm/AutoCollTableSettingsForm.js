...
class AutomaticCollationTableSettingsForm {
  ...
  constructor(containerSelector) {
    ...
    this.savePresetButton = $(this.containerSelector + ' .save-preset-btn')
  ...
  setSettings(availableWitnesses, settings, noneIncludedMeansAll = true) {
    this.initialSettings = settings
    ...
    if(noneIncludedMeansAll && settings.witnesses.length === 0) {
  ...
  getTitleFromSettings(langDef, availableWitnesses = false, settings = false) {
    if (availableWitnesses === false) {
      availableWitnesses = this.witnessList
    }
    ...
    if (numWitnesses === 0) {
      numWitnesses = availableWitnesses.length
    }
    
    title += langDef[settings.lang].name + ', '
    title += numWitnesses  + ' of ' 
    title += availableWitnesses.length + ' witnesses'
  ...
  genOnClickAllButton() {
    ...
    return function() {
      ...
      thisObject.setOptions(thisObject.witnessList, newSettings)
      thisObject.dispatchEvent(thisObject.settingsChangeEventName, thisObject.getSettings())
    }
  }
  ...
  genOnClickNoneButton() {
    ...
    return function() {
      ...
      let newSettings = thisObject.getSettings()
      newSettings.witnesses = []
      thisObject.setOptions(thisObject.witnessList, newSettings, false)
      thisObject.dispatchEvent(thisObject.settingsChangeEventName, thisObject.getSettings())
