...
Modified for Averroes Project by Rafael Nájera, rafael.najera@uni-koeln.de, 2018
  - Single event handler for resizing horizontal and vertical percent panes.
...
(function ($) {
	...
	function createParentresizeHandler($splitPane) {
		...
		} else if ($splitPane.is('.horizontal-percent') ||$splitPane.is('.vertical-percent') ) {
          /**
           * Changes for Averroes Project start here
           */
			return function(event) {
            ...
            // end of changes for Averroes Project
		} else if ($splitPane.is('.fixed-left')) {
			return function(event) {
				var lastComponentMinWidth = minWidth(components.last),
...
//        else if ($splitPane.is('.vertical-percent')) {
//			return function(event) {
//                console.log("Resizing vertical percent")
//				var lastComponentMinWidth = minWidth(components.last),
//					firstComponentMinWidth = minWidth(components.first),
//					maxLastComponentWidth = components.splitPane.offsetWidth - firstComponentMinWidth -  components.divider.offsetWidth;
//				if (components.last.offsetWidth > maxLastComponentWidth) {
