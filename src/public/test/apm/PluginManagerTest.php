...
class PluginManagerTest extends TestCase {
    ...
    public function testBasic() 
    {
        ...
        $result = $pm->addPluginDir(__DIR__ . '/test-plugins/baddir');
        $this->assertFalse($result);
        $this->assertEquals(PluginManager::PM_ERROR_INVALID_DIR, $pm->error);
        $this->assertCount(1, $pm->pluginDirs);
        
        $result2 = $pm->addPluginDir(__DIR__ . '/test-plugins/basic2');
    ...
    public function testLoadDirs()
    {
        ...
        $result = $pm->loadPluginDir(__DIR__ . '/test-plugins/basic');
        ...
        $result2 = $pm->loadPluginDir(__DIR__ . '/test-plugins/basic2', 'BadClass');
        $this->assertFalse($result2);
        
        $result3 = $pm->loadPluginDir(__DIR__ . '/test-plugins/basic2', 'BasicPlugin2');
        $this->assertTrue($result3);
    ...
    public function testActivate()
    {
        ...
        $result = $pm->activatePlugin(__DIR__ . '/test-plugins/basic', 'BasicPlugin');
        $this->assertTrue($result);
        ...
        $result2 = $pm->activatePlugin(__DIR__ . '/test-plugins/basic', 'BasicPlugin');
        $this->assertTrue($result2);
        $this->assertCount(1, $pm->pluginObjects);
        $this->assertEquals(6, $basicPluginObject->myVar);
        
        $result3 = $pm->deactivatePlugin(__DIR__ . '/test-plugins/basic', 'BasicPlugin');
        $this->assertTrue($result3);
    ...
    public function testLoadActivePlugins()
    {
        ...
        $badPlugins2[] = ['dir' => __DIR__ .  '/test-plugins/basic', 'class' => 'BasicPlugin']; // <-- this is good
        $sm->setSetting(PluginManager::PM_ACTIVE_PLUGINS_SETTING, 
