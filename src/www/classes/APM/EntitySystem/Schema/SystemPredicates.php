...
const BasicEntityPredicateDefs = [
    ...
    [
        ...
        'allowedSubjectTypes' => [ Entity::tPerson, Entity::tGeographicalPlace, Entity::tGeographicalArea, Entity::tWork, Entity::tDocument, Entity::tInstitution, Entity::tBook, Entity::tBookSection, Entity::tArticle, Entity::tOldCatalog, Entity::tOnlineCatalog],
