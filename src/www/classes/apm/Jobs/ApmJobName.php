...
class ApmJobName
{
    ...
    const UPDATE_OPENSEARCH_INDEX = 'Update OpenSearch Index';
    const SEARCH_PAGE_UPDATE_TRANSCRIBERS_AND_TITLES_CACHE = 'Search page Update Transcribers and Titles Cache';
