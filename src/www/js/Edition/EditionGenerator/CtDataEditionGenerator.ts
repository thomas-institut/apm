...
import { EditionMainTextGenerator } from './EditionMainTextGenerator'
...
export class CtDataEditionGenerator extends EditionGenerator {
   ...
   * @private
   */
  _getCustomEntriesForApparatusType(apparatusType: string): Apparatus | null{
   ...
   * @private
   */
  _mergeCustomApparatusEntries(apparatusType: string, generatedApparatus: Apparatus,
                               baseWitnessTokens: WitnessTokenInterface[], ctIndexToMainTextMap: any[]): Apparatus {
   ...
   */
  __mergeCustomSubEntries(currentSubEntries: ApparatusSubEntry[], newSubEntries: ApparatusSubEntry[]) {
  ...
  hasEntryCustomizations(customEntry: ApparatusEntry) {
   ...
   * @private
   */
  _applyCustomAutoSubEntriesToGeneratedSubEntries(generatedSubEntries: ApparatusSubEntry[],
                                                  customAutoSubEntries: ApparatusSubEntry[]): ApparatusSubEntry[] {
   ...
   * @private
   */
  _buildSubEntryArrayFromCustomSubEntries(customSubEntries: ApparatusSubEntry[]): ApparatusSubEntry[] {
   ...
   * @private
   */
  _getCustomApparatuses(ctIndexToMainTextMap: number[], baseWitnessTokens: WitnessTokenInterface[]): Apparatus[] | any[] {
    if (this.ctData.customApparatuses === undefined) {
      return []
    }
