...
export class BootstrapTabGenerator {
  ...
  async generateHtml() {
    return this.genTabListDiv() + await this.genTabContentDiv()
  }
  ...
  genTabListDiv() {
    ...
    return  `<div class="tab-list"><ul class="nav nav-tabs" id="${this.getTabListId()}" role="tablist">` +
