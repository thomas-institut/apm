...
class DataTablePresetManagerTest extends PresetManagerTest {
    ...
    public function createEmptyPresetManager(): PresetManager {
    ...
    public function testIdMethods() {
        ...
        $preset = new Preset($toolName, $userId, $title, $data, $data);
        ...
        $preset2 = new Preset($toolName, $userId, $title, $data2, $data2);
